<template>
    <div class="bg-white rounded shadow p-4 w-2/3">
        <div class="flex justify-between items-center">
            <div>
                <div class="w-8">
                    <img src="https://images.unsplash.com/photo-1581688344756-4081c0d3abe9?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60"
            ...
            <div>
                <button class="dz-clickable flex justify-center items-center rounded-full w-10 h-10 bg-gray-200">
