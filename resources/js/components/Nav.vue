<template>
    <div class="bg-white flex h-12 items-center px-4 border-b border-gray-400 shadow-sm">
        <div class="w-1/3">
            <div class="flex items-center">
                ...
                <div class="ml-2 relative">
                    ...
                    <input class="text-sm h-8 w-56 pl-8 pr-3 bg-gray-200 rounded-full focus:outline-none focus:shadow-outline" placeholder="Some text to find..." type="text">
                </div>
        ...
        <div class="w-1/3 flex justify-center items-center h-full">
            ...
            <router-link v-if="authUser" :to="`/users/${authUser.data.user_id}`" class="px-6 border-b-2 border-white h-full flex items-center">
                <img src="https://images.unsplash.com/photo-1581688344756-4081c0d3abe9?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60" alt="Facebook clone" class="w-8 h-8 object-cover rounded-full">
            </router-link>
